...
function dartSessionstorage() {

}
dartSessionstorage.prototype.run = function() {
  var countStr = get$$window().sessionStorage.$index("count");
  var count = countStr != null ? Math.parseInt(countStr) : (0);
  count++;
  get$$window().sessionStorage.$setindex("count", count.toString());
  this.write(("Hello World! (" + count + ")"));
}
dartSessionstorage.prototype.write = function(message) {
